  ...
  return (
    <div className="lg:min-h-screen relative sample-section w-full p-4 pt-10 pb-10">
      <div className="flex justify-start items-center lg:pt-[8%]">
        <div className="flex gap-4 flex-col lg:grid lg:grid-cols-3 lg:pl-10 lg:pr-10 lg:gap-4 w-full">
          <div className="lg:col-span-3">
            <p className="text-4xl text-center p-4 brnone lg:text-left lg:text-3.5vw font-extrabold lg:pb-6">
              10년 이상의 업력으로 <br />
              축적된 다양한 노하우 보유
            </p>
            <p className="text-base text-zinc-500 p-4 pt-0 lg:pb-6 text-center lg:text-left lg:text-1vw brnone t2">
              10년 이상 축적된 학술 조사 진행 노하우를 바탕으로 다양한 조사
              기법을 활용하여 <br />
              다양한 주제와 조사 대상에 대해 빠르고 정확한 조사를 수행할 수
              있습니다.
            </p>
          </div>
          <div className="rounded-xl bg-gray-50 p-8 lg:p-[2.5vw] t3">
            <p className="flex items-center  font-black text-2xl lg:text-1.8vw pb-2">
              <img
                src={process.env.PUBLIC_URL + "/images/service_ico1.png"}
                alt=""
                className="w-10 pr-2"
              ></img>{" "}
              언론/미디어/정치
          ...
          <div className="rounded-xl bg-gray-50 p-8 lg:p-[2.5vw] t4">
            <p className="flex items-center  font-black  text-2xl lg:text-1.8vw pb-2">
              <img
                src={process.env.PUBLIC_URL + "/images/service_ico2.png"}
                alt=""
                className="w-10 pr-2"
              ></img>{" "}
              의료/보건
          ...
          <div className="rounded-xl bg-gray-50 p-8 lg:p-[2.5vw] t5">
            <p className="flex items-center  font-black  text-2xl lg:text-1.8vw pb-2">
              <img
                src={process.env.PUBLIC_URL + "/images/service_ico3.png"}
                alt=""
                className="w-10 pr-2"
              ></img>{" "}
              심리/상담
          ...
          <div className="rounded-xl bg-gray-50 p-8 lg:p-[2.5vw] t6">
            <p className="flex items-center  font-black  text-2xl lg:text-1.8vw pb-2">
              <img
                src={process.env.PUBLIC_URL + "/images/service_ico4.png"}
                alt=""
                className="w-10 pr-2"
              ></img>{" "}
              직군/산업
          ...
          <div className="rounded-xl bg-gray-50 p-8 lg:p-[2.5vw] t7">
            <p className="flex items-center  font-black  text-2xl lg:text-1.8vw pb-2">
              <img
                src={process.env.PUBLIC_URL + "/images/service_ico5.png"}
                alt=""
                className="w-10 pr-2"
              ></img>{" "}
              관광
          ...
          <div className="rounded-xl bg-gray-50 p-8 lg:p-[2.5vw] t8">
            <p className="flex items-center  font-black  text-2xl lg:text-1.8vw pb-2">
              <img
                src={process.env.PUBLIC_URL + "/images/service_ico6.png"}
                alt=""
                className="w-10 pr-2"
              ></img>{" "}
              아동/청소년
          ...
          <div className="col-span-3 text-right italic lg:mt-1 lg:text-1vw">
            실제 수행 내역 중 최신 트렌드를 반영한 조사만 일부 소개했습니다.
          </div>
        </div>
      </div>
    </div>
