...
import { SectionService02_List_Mobile , SectionService02_List } from "./Section_Service02_list";
...
<div className="lg:h-screen relative w-full pb-10" style={{background: '#F3EFED'}}>
<Servicedep />

<div className='flex flex-col justify-center items-center lg:h-screen '>
    <div className='text-4xl font-bold pb-6 lg:text-7xl lg:pb-10 text-center p-10'>프로젝트 별 <span className='text-c3'>전담 연구원</span> 배치</div>
...
연구원은 연구자들의 학술 조사에만 집중할 수 있도록 개발 및 패널 관리는 개별 팀에서 담당합니다.</p>
  ...
  {window.innerWidth < 768 ? <SectionService02_List_Mobile /> : <SectionService02_List />}
