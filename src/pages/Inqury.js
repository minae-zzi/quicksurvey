    ...
    <div className="break-keep">
      ...
      <div className='flex flex-col items-center justify-center lg:p-20 p-8 pt-10 pb-10'>
        ...
        <div className='lg:w-8/12 text-center'>
          <p className='font-bold text-4xl lg:text-7xl text-center'>한국리서치 <span className='text-c1'>Quick Survey</span>에<br />궁금한 것이 있으신가요?</p>
          <p className='lg:text-xl lg:pt-8 lg:pb-8 text-center leading-tight pt-4 pb-4'>아래의 내용을 기재해 주시면 신속하게 답변해 드리겠습니다.</p>

          <div className='rounded-xl bg-zinc-50 p-10 mb-8 text-left'>
            <p className='flex items-center font-bold text-lg pb-4'><input type="checkbox" className='bg-c1 text-white w-6 h-6 mr-2 rounded-md'></input> 개인정보 수집 및 이용 동의(필수)</p>
            <p className='lg:h-auto h-[100px] overflow-auto'>아래와 같이 개인정보를 수집, 이용하고자 합니다. 내용을 읽고 동의여부를 결정해 주시기 바랍니다.<br />
